...
with DAG(
    ...
    with TaskGroup(group_id='group1') as fg1:
        f1 = FileSensor(
            ...
            fs_conn_id="fs_local", 
            filepath=str(datetime.now().date()) + "customer_research.csv", 
            poke_interval=5 , 
        ...
        f2 = FileSensor(
            ...
            fs_conn_id="fs_local", 
            filepath=str(datetime.now().date()) + "user_order_log.csv", 
            poke_interval=5, 
        ...
        f3 = FileSensor(
            ...
            fs_conn_id="fs_local", 
            filepath=str(datetime.now().date()) + "user_activity_log.csv", 
            poke_interval=5, 
